...
<html lang="en-US">
<head>
<title>Великая Японская Империя</title>
<meta charset="utf-8">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx1-heading pulsate'>
							<h1>Великая Японская Империя
							 </h1>
						</div>
						<div class='landing-tx2-heading'>
							<p>
								 Мы большой и сильный сквад TEIKO. <br> Рады вас приветствовать на нашем сайте
							</p>
							<div>
								<div>
									</a>
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/test/hero-main.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 Дискорд сервер нашей страны, здесь вы увидете красивые города и сильную армию
								</p>
							</div>
							<a href="https://discord.gg/XJVSbBjAMe" target="_blank">
